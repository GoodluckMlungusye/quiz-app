...
import 'package:quiz_app/categories/R_quiz.dart';
import 'package:quiz_app/pages/Question.dart';
import 'package:percent_indicator/percent_indicator.dart';

class R_plain extends StatefulWidget {
  const R_plain({Key? key}) : super(key: key);

  @override
  State<R_plain> createState() => _R_plainState();
}

class _R_plainState extends State<R_plain> {
